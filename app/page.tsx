  ...
  return (
    <div>
      ...
      <div className="relative">
        <Image src={topimg} className="objectFill"></Image>
        <div className="w-full absolute top-20 right-40 text-center mt-10">
      ...
      */}
      <div className="w-vw h-[32rem] bg-[url('../app/assets/Orange-Gradient.jpg')] bg-cover bg-no-repeat grid place-items-center">
        <h1>Test</h1>
      </div>
      ...
      <div className="w-vw h-[32rem] bg-[url('../app/assets/Orange-Gradient-flipped.jpg')] bg-cover bg-no-repeat grid place-items-center">
