...
import topimg from '../app/assets/Orange-Gradient.jpg'
import backimg from '../app/assets/Orange-Gradient-flipped.jpg'
    ...
    <div className="bg-white">
      <div className="w-vw -mt-36 h-[45rem] bg-[url('../app/assets/sunset-city-gradient.jpg')] bg-cover bg-no-repeat grid place-items-center">
        <div className="text-center">
          <h2 className="text-5xl text-transparent bg-clip-text font-extrabold bg-gradient-to-r from-white to-white p-2">
      ...
      <div className="w-vw h-[36rem] bg-[url('../app/assets/Orange-Gradient-flipped.jpg')] bg-cover bg-no-repeat grid place-items-center">
        <section className="dark:bg-white">
          <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
              <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
                  ...
                  <p className="font-light sm:text-xl text-white">Explore the whole collection of open-source web components and elements built with the utility classes from Tailwind</p>
              </div> 
