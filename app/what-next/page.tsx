...
export default function Home() {
  return (
    <div className="bg-white">
                        ...
                        <div className="mt-4 md:mt-0">
                            ...
                            <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
                                ...
                                <ul className="list-disc list-inside">
                                  <li>A <a href="https://www.schufa.de/" className="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">Schufa report</a> (germ.: Schufa Auskunft)</li>
                                  <li>A proof of salary (germ.: Gehaltsnachweis)</li>
        ...
        <section className="bg-white dark:bg-gray-900 -mt-10 border-t-4 border-primary">
            <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
                ...
                <dl className="grid max-w-screen-md gap-8 mx-auto text-gray-900 sm:grid-cols-3 dark:text-white">
                    <div className="flex flex-col items-center justify-center">
                        <dt className="mb-2 text-3xl md:text-4xl font-extrabold">6-12 months</dt>
